...
class Combatant(
    ...
    /**
     * Сколько раз бойца задело критом. Растёт только от удара, который сам
     * был критом, — по нему интерфейс и красит всплывающее число, а не по
     * «последнему броску в бою», который к яду отношения не имеет.
     */
    var critsTaken by mutableIntStateOf(0)
