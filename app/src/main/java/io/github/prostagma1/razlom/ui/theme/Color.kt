...
object Field {
    ...
    val rock = Color(0xFF3B4150)
    val rockTop = Color(0xFF4A5162)
    val tree = Color(0xFF2E4A35)
    val treeTop = Color(0xFF3F6B49)
    val bramble = Color(0xFF3A3126)
    val brambleLine = Color(0xFF5A4C36)
    val fog = Color(0xFF080A0E)
